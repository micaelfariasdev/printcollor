                ...
                {(filtrados as any[]).map((item) => (
                    ...
                    >
                        ...
                        <div className="h-44 bg-slate-100 relative group">
                            ...
                            >
                                <span
                                    className={`px-3 py-1 rounded-lg text-[10px] font-black uppercase shadow-md transition-all active:scale-90 hover:brightness-110 cursor-pointer ${item.status === 'finalizado'
                        ...
                        <div className="p-5 flex-1 text-left">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-[11px] font-bold text-slate-500 uppercase">
                                ...
                                {item.data_entrega &&<div className="flex items-center gap-1.5 justify-end">
