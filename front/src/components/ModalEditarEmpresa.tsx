...
const ModalEditarEmpresa: React.FC<Props> = ({ isOpen, onClose, onSuccess, empresaId }) => {
      ...
      <div className="bg-white w-full max-w-lg rounded-[2.5rem] shadow-2xl overflow-hidden border border-slate-100">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            <button type="button" onClick={onClose} className="flex-1 py-4 rounded-2xl font-bold text-slate-500 hover:bg-slate-100 transition-all">
              Cancelar
            </button>
            <button 
              type="submit" 
