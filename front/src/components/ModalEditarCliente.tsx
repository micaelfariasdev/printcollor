    ...
    if (isOpen && clienteId) {
      ...
      api.get(`clientes/${clienteId}/`)
        .then((res) => {
          ...
          // Define o toggle inicial baseado no que está preenchido
          setTipoDocumento(res.data.cnpj ? 'CNPJ' : 'CPF');
        })
      ...
      <div className="bg-white w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden border border-slate-100">
        ...
        <div className="p-8 border-b border-slate-50 flex justify-between items-center">
          <h2 className="text-2xl font-black text-slate-800 uppercase italic">
            Editar <span className={theme.colors.accentText}>Cliente</span>
          </h2>
